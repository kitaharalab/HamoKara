...
public class CheckHamo4_all extends PApplet{
...
/			System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~");
			*/
			...
			for(int i=0;i<mainNotelist.length;i++){
				println(abs((int)(mainNote[i]-notenumCheck[i])));        
				hamoW[abs((int)(mainNote[i]-notenumCheck[i]))]=hamoW[abs((int)(mainNote[i]-notenumCheck[i]))]+1;
